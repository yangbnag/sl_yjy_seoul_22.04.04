...
// 수정 모드 진입처리
function enterModifyMode(target) {
//아이콘 변경
// 선택된 라벨의 다음형제의 태그교체
// 선택된 span의 클래스 교체
//<span class="lnr lnr-checkmark-circle"></span>

if (target.classList.contains('lnr-undo')) {
...
const $textSpan = target.parentElement.previousElementSibling.nextElementSibling.lastElementChild;
...
const $par = $textSpan.parentElement;
console.log($par);

// $par.replaceChild($newInput,$par.lastElementChild);
